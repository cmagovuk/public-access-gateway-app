class Router
    ...
    Routes = {
        :business       => [:classify, :businesses, :what_happened, :nation, :evidence, :contact, :review, :information_use, :summary],
        :sector         => [:classify, :what_happened, :nation, :evidence, :contact, :review, :information_use, :summary],
        :more           => [:classify, :related_reference_number, :what_happened, :evidence, :contact, :review, :information_use, :summary],
        :ongoing        => [:classify, :related_investigation, :what_happened, :evidence, :contact, :review, :information_use, :summary],
        :cartels        => [:classify, :cartels],
        :whistleblowing => [:classify, :whistleblowing],
        :other          => [:classify, :businesses, :what_happened, :nation, :evidence, :contact, :review, :information_use, :summary]
    }.freeze
